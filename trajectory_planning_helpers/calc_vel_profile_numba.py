...
@cc.export('__solver_fb_unclosed', 'float64[:](float64[:,:,:], float64[:,:], float64, float64[:], float64[:], float64, float64, float64, unicode_type, optional(float64[:]), optional(float64), optional(float64))')
@jit(nopython=True, cache=True)
...
@cc.export('__solver_fb_closed', 'float64[:](float64[:,:,:], float64[:,:], float64, float64[:], float64[:], float64, float64, unicode_type, optional(float64[:]),optional(float64))')
@jit(nopython=True, cache=True)
